...
async function main() {
    ...
    let deploymentBlocks = [/*2804761,2862668,2950246,3068748,3078978,3106205,*/3283501,3327307,3357919,3395391,3648868];

    let lastBlock = [/*2867362,3097542,3635977,3078717,3109709,3696335,*/3325844,3364014,3394623,0,0];
